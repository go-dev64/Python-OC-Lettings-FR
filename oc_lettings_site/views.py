...
def index(request: HttpRequest) -> HttpResponse:
    ...
    Args:
        request (HttpRequest): The object representing the incoming HTTP request.
...
def handler404(request: HttpRequest, exception: Exception) -> HttpResponse:
    ...
    Args:
        request (HttpRequest): The object representing the incoming HTTP request
        exception (Exception): The exception raised when a 404 error occurs.
...
def handler500(request: HttpRequest) -> HttpResponse:
    """The function is used to return a customized 500 Server Internal error page.
