...
# a specific letting. It uses data from the 'Letting' model and renders HTML
...
def letting(request: HttpRequest, letting_id: int) -> HttpResponse:
    ...
    'letting_id' and renders it in the 'lettings/letting.html' template.

    Args:
        request (HttpRequest): The incoming HTTP request.
        letting_id (int): The unique identifier of the letting to be displayed.

    Returns:
        HttpResponse: A rendered HTML response displaying the specific letting.
    """
